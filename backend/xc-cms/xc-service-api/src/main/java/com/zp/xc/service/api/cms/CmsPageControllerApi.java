...
public interface CmsPageControllerApi {
     ...
     * @return 分页的page
     */
    @Operation(summary = "分页查询页面列表", description = "分页查询页面列表信息")
    @Parameters({
     ...
     * @return
     */
    @Operation(summary = "新增页面", description = "")
    CmsPageResult addCmsPage(CmsPage page);

    @Operation(summary = "根据ID查询页面信息", description = "")
    @Parameter(
            name = "id",
            description = "页面ID",
            required = true,
    ...
    @Operation(summary = "修改页面", description = "")
    @Parameter(name = "id", description = "页面ID", required = true, in = ParameterIn.PATH,
            schema = @Schema(type = "string"))
    CmsPageResult edit(String id, CmsPage page);

    @Operation(summary = "通过ID删除页面", description = "")
    @Parameter(name = "id", description = "页面ID", required = true, in = ParameterIn.PATH,
            schema = @Schema(type = "string"))
